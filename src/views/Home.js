         ...
         <div className={`${loading && "h-screen"}`}>
            <div className="md:flex-row flex flex-col w-full mb-10">
               ...
               <div className="md:mt-3 flex flex-col items-center w-full">
                  <div className="hidden md:flex justify-center mb-2 w-full space-x-1">
                     <input
                        type="text"
                        className="block px-4 py-2 bg-white border rounded-full focus:border-blue-500 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                        placeholder="Search ..."
                     />
